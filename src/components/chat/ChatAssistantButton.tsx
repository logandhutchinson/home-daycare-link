        ...
        {open && (
          ...
          >
            <div className="gradient-primary px-4 py-3 flex items-center justify-between">
              <div>
                <h3 className="font-display font-semibold text-primary-foreground text-sm">CareHub Assistant</h3>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              <div className="bg-secondary rounded-xl px-3 py-2.5 text-sm text-secondary-foreground max-w-[85%]">
                Hi! I'm your CareHub assistant. I can help with scheduling, documentation, and policy questions. What do you need?
              </div>
            </div>
